...
The SPL manifest has 68 records and 67 evidence cases. Its current syntax summary is 57 supported, 1 unsupported, and 10 unassessed; semantics is 49 supported, 9 unsupported, and 10 unassessed. The SPL2 manifest has 98 records and 108 evidence cases; syntax is 69 supported, 19 unsupported, and 10 unassessed; semantics is 50 supported, 38 unsupported, and 10 unassessed. Requirements and linting are fully unassessed in both snapshots. Safe rewriting is 1 unsupported with the remainder unassessed in each snapshot.
