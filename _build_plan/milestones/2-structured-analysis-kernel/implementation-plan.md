...
- [x] Task 6: complete at 35da878 after independent task review; both local installed wheel paths each pass 44 native + 15 surface tests with zero skips, all 26 report cases and capabilities equivalent, docs/evidence complete. Broad milestone review and root final acceptance remain.
