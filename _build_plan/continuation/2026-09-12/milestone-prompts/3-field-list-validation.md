...
- Read `@_build_plan/milestones/1-trustworthy-baseline/milestone-log.md` and `@_build_plan/milestones/2-structured-analysis-kernel/milestone-log.md` to understand what has already been built.
...
4. When complete, write a `milestone-log.md` in this folder (`_build_plan/milestones/3-field-list-validation/milestone-log.md`). Structure it as follows:
